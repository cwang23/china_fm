...
# setwd("C:/Users/clara/Documents/china_fm/chinafm_app")
rm(list = ls())
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          p("Words shown in the wordcloud are limited to the statements ",
            "selected based on the filtering above."),
          p("Note that filters based on Chinese characters will only apply ",
            "to wordclouds plotted in Chinese. The same holds true for filters ",
            "based on English words. Only a wordcloud plotted in English will ",
            "be restricted to statements based off English word filters, ",
            "even if you set filters based on ",
